...
/*   Updated: 2018/04/11 15:49:44 by ysingaye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	hardcode_op(t_op *op)
{
	...
	op[8] = set_op(DIRFOR, 1, 0);
	op[9] = set_op(DIRTWO, 0, DIR_CODE);
	op[10] = set_op(DIRTWO, 1, 0);
	op[11] = set_op(DIRTWO, 1, 0);
	op[12] = set_op(DIRTWO, 0, DIR_CODE);
	op[13] = set_op(DIRFOR, 1, 0);
	op[14] = set_op(DIRTWO, 1, 0);
